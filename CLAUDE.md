# Job Search -- AI-Powered Job Search Pipeline

## Origin

This system is based on [career-ops](https://github.com/santifer/career-ops) by Santiago Fernandez, customized for **Ganesh Hemanth Mamidipalli** -- AI Engineer specializing in LLM Systems, Generative AI Infrastructure, Agentic Platforms, and MLOps.

The archetypes, scoring logic, and proof point structure have been tailored for AI/ML Engineering, LLMOps, and Agentic Systems roles targeting the US market.

**It's designed to be continuously customized.** Ask the AI Agent to change archetypes, scoring, companies, or any other aspect.
